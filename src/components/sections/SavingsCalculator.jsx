...
const SavingsCalculator = () => {
    ...
    return (
        <section id="calculator" className="py-16 md:py-24 lg:py-16 md:py-32 bg-primary-surface dark:bg-primary transition-colors duration-300 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="mb-10 md:mb-12 flex flex-col md:flex-row md:items-end justify-between gap-10">
                    <div>
                        <span className="label-caps !mb-6 italic">Financial Intelligence</span>
